...
public class OrderApprovedKafkaMessagePublisher implements OrderApprovedMessagePublisher {
    ...
    private final RestaurantKafkaMessageHelper restaurantKafkaMessageHelper;
    ...
    public OrderApprovedKafkaMessagePublisher(RestaurantMessagingDataMapper restaurantMessagingDataMapper,
                                              ...
                                              RestaurantKafkaMessageHelper restaurantKafkaMessageHelper) {
        this.restaurantMessagingDataMapper = restaurantMessagingDataMapper;
        this.kafkaProducer = kafkaProducer;
        this.restaurantServiceConfigData = restaurantServiceConfigData;
        this.restaurantKafkaMessageHelper = restaurantKafkaMessageHelper;
    }
    ...
    public void publish(OrderApprovedEvent orderApprovedEvent) {
        ...
        try {
            ...
            kafkaProducer.send(restaurantServiceConfigData.getRestaurantApprovalResponseTopicName(),
                    ...
                    restaurantKafkaMessageHelper.getKafkaCallback(restaurantServiceConfigData
