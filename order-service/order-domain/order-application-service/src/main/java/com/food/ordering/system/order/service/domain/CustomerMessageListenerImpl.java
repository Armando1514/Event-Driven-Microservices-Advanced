...
import com.food.ordering.system.order.service.domain.ports.input.service.message.listener.customer.CustomerMessageListener;
...
public class CustomerMessageListenerImpl implements CustomerMessageListener {
    ...
    public void customerCreated(CustomerModel customerModel) {
        ...
        log.info("Customer is created in order with id: {}", customer.getId());
    }
}
